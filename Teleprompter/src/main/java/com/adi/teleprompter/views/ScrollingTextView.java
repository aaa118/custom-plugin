...
public class ScrollingTextView extends androidx.appcompat.widget.AppCompatTextView implements Runnable {
    ...
    public String getInfo() {
        return String.valueOf(" CX: "+scroller.getCurrX() +" CY: "+ scroller.getCurrY()+" FX: " +
                scroller.getFinalX()+" FY: " +scroller.getFinalY() + " SX: "+ scroller.getStartX() + " SY: "+ +scroller.getStartY());
    }
